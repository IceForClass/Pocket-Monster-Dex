  ...
  <header class="p-3 bg-dark text-white">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <div class="text-end">
          <button id="boton_modo" type="button" class="btn btn-warning" title="Pulsame"><i
              ...
              <div class="row g-0">
                  ...
                  <div class="card-body p-md-5 mx-md-4">
                    ...
                    <form method="POST" action="../sql/checklogin.php">
                      ...
                      <div class="form-outline mb-4">
                        <input type="text" id="usuario" name="usuario" value="" class="form-control" <label class="form-label"
                          for="form2Example11">Nombre De Usuario</label>
                      </div>
                      ...
                      <div class="d-flex align-items-center justify-content-center pb-4">
                        <p class="mb-0 me-2" ¿No tienes una cuenta?</p>
                          <a type="button" href="sign.php" class="btn btn-outline-danger">Crea una nueva</a>
                      </div>
                ...
                <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                  <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                    ...
                    <p class="small mb-0">Sumérgete en la aventura de capturar y entrenar a estos increíbles seres.
                      Descubre sus habilidades únicas y desafía a otros entrenadores en tu camino hacia la maestría en
                      el Pocket Monster Dex.</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="container">
      ...
      <section>
        ...
        <a data-mdb-ripple-init class="btn btn-link btn-floating btn-lg text-body m-1"
          href="https://github.com/IceForClass/Pocket-Monster-Dex" role="button" data-mdb-ripple-color="dark"><i
